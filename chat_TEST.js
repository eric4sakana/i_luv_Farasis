 ...
 */
 ...
 class ChatRobot {
     ...
     async sendTextMsg(msg, options) {
         const textMsgInfo = {
             "msgtype": "text",
             //chatid,
             "text": {
                 "content": msg,
                 "mentioned_list":["@liuyifan(022633)", "@all"],
                 ...options
             }
         };
      ...
      */
     async sendMdMsg(content, options) {
     ...
     // 图文消息用于发送头像 实验  added by Yifan 2021/6/12   
     async sendAvatarMsg(msg, options) {
        const AvatarMsgInfo = {
            "msgtype": "image",
            //chatid,
            "image": {
        ...
        return await this.sendHttpRequest(AvatarMsgInfo);
    }
